...
model_dir = data_dir + 'model_dic/' + 'mouse_mucosa_model_ae.pth'
aspect_keys = ['stimulus']
...
if __name__ == '__main__':
    ...
    data.obs['condition'] = data.obs['stimulus']
    adata = preprocess(data, size_factor=True)
    adata.raw = adata
    adata = my_func(adata)
    adata.write_h5ad(data_dir + "mouse_mucosa_scDisco_ae.h5ad")
