...
plot_umap_all(scVI, 'celltype', 'scVI', axs[0][2], show=False)
plot_umap_all(scVI, 'batch', 'scVI', axs[1][2], show=False)
plot_umap_all(scVI, 'condition', 'scVI', axs[2][2], show=False)
plot_umap_all(DESC, 'celltype', 'DESC', axs[0][3], show=False)
plot_umap_all(DESC, 'batch', 'DESC', axs[1][3], show=False)
plot_umap_all(DESC, 'condition', 'DESC', axs[2][3], show=False)
plot_umap_all(cell_BLAST, 'celltype', 'Cell BLAST', axs[0][4], show=False)
plot_umap_all(cell_BLAST, 'batch', 'Cell BLAST', axs[1][4], show=False)
plot_umap_all(cell_BLAST, 'condition', 'Cell BLAST', axs[2][4], show=False)
plt.savefig(data_dir + 'figures/umap/figure8A.png', dpi=600, format='png', bbox_inches='tight')
