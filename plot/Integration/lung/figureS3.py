...
# %%
plot_umap_all(Seurat, 'celltype', 'Seurat', axs[0][0], show=False)
plot_umap_all(Seurat, 'batch', 'Seurat', axs[1][0], show=False)
plot_umap_all(Seurat, 'condition', 'Seurat', axs[2][0], show=False)
...
plot_umap_all(Harmony, 'celltype', 'Harmony', axs[0][4], show=False)
plot_umap_all(Harmony, 'batch', 'Harmony', axs[1][4], show=False)
plot_umap_all(Harmony, 'condition', 'Harmony', axs[2][4], show=False)
plt.savefig(data_dir + 'figures/umap/figure4S.png', dpi=600, format='png', bbox_inches='tight')