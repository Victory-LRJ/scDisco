...
methods = ['scDisinfact', 'scanorama', 'desc', 'scidrl', 'cell_blast', "seurat", 'scVI', "harmony", "scDisco"]
...
colors = ['lightsalmon', 'pink', 'thistle', 'lightgray', 'mistyrose', 'powderblue', 'darkseagreen', 'paleturquoise', 'gold']
labels = ['scDisInFact', 'Scanorama',  'DESC', 'SCIDRL', 'Cell BLAST', "Seurat", 'scVI', "Harmony", "scDisco"]
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/figure2B1.svg', dpi=300, format='svg', bbox_inches='tight')
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/figure2B2.svg', dpi=300, format='svg', bbox_inches='tight')
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/simulate_nmi.svg', dpi=300, format='svg', bbox_inches='tight')
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/simulate_SAS.svg', dpi=300, format='svg', bbox_inches='tight')
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/simulate_basw.svg', dpi=300, format='svg', bbox_inches='tight')
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/simulate_casw.svg', dpi=300, format='svg', bbox_inches='tight')
...
axes.set_ylim(0, 1)
fig.tight_layout()
plt.savefig(data_dir + 'figures/evaluation/simulate_asw.svg', dpi=300, format='svg', bbox_inches='tight')
